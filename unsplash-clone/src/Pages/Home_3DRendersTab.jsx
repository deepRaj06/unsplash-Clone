...
const Home_3DRendersTab = () => {
  ...
  const editorialImg = {
    blurImg:
      "url(https://images.unsplash.com/photo-1658225282648-b199eb2a4830?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1vZi10aGUtZGF5fHx8fGVufDB8fHx8&dpr=1&auto=format%2Ccompress&fit=crop&w=1599&h=594) center/cover no-repeat",
  };
  return (
    <>
                ...
                <VStack spacing="24px" alignItems="start">
                  ...
                  <VStack spacing="2px" alignItems="start">
                    <Text fontSize="20px" color="white">
                      For the first time ever, Unsplash is accepting a new
                      category of images
                    </Text>
                    <Text fontSize="20px" color="white">
                      outside of photography. Submit your 3-dimensional images,
                      designed in
                    </Text>
                    <Text fontSize="20px" color="white">
                      the software of your choice, rendered into JPEG images.
                    </Text>
                  </VStack>
                  <Button
                  ...
                  >
                    <Flex>
                      ...
                      <Text fontWeight="bold">3D Renders</Text>
                    </Flex>
                  </Button>
                </VStack>
              </Box>
...
export default Home_3DRendersTab;
