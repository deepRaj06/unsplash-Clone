...
const ImageGrid_CurrentEvents = () => {
  ...
  useEffect(() => {
    axios({
      url: `https://api.unsplash.com/search/photos/?query=current-events&per_page=100&client_id=${API};`,
      method: "GET",
    }).then((res) => {
...
export default ImageGrid_CurrentEvents;
