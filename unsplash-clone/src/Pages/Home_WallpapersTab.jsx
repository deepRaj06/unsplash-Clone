...
const Home_WallpapersTab = () => {
  ...
  const editorialImg = {
    blurImg:
      "url(https://images.unsplash.com/photo-1658233126994-e383874733ba?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1vZi10aGUtZGF5fHx8fGVufDB8fHx8&dpr=1&auto=format%2Ccompress&fit=crop&w=1599&h=594) center/cover no-repeat",
  };
  return (
    <>
                ...
                <VStack spacing="24px" alignItems="start">
                  ...
                  <VStack spacing="2px" alignItems="start">
                    <Text fontSize="20px" color="white">
                      From epic drone shots to inspiring moments in nature —
                      submit your best
                    </Text>
                    <Text fontSize="20px" color="white">
                  ...
                  >
                    <Flex>
                      ...
                      <Text fontWeight="bold">Wallpapers</Text>
                    </Flex>
                  </Button>
                </VStack>
              </Box>
...
export default Home_WallpapersTab;
