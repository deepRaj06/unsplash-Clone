...
const ImageGrid_ThreeDRenders = () => {
  ...
  useEffect(() => {
    axios({
      url: `https://api.unsplash.com/search/photos/?query=3d-renders&per_page=100&client_id=${API};`,
      method: "GET",
    }).then((res) => {
...
export default ImageGrid_ThreeDRenders;
