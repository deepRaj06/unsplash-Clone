...
const ImageGrid_ArchitectureTab = () => {
  ...
  useEffect(() => {
    axios({
      url: `https://api.unsplash.com/search/photos/?query=architecture&per_page=100&client_id=${API};`,
      method: "GET",
    }).then((res) => {
...
export default ImageGrid_ArchitectureTab;
