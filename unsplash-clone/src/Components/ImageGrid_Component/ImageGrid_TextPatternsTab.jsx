...
import { Box, Flex, Grid, GridItem, Icon, Image, Link, Spacer, Text, Tooltip } from "@chakra-ui/react";import axios from "axios";
import React, { useContext, useEffect, useState } from "react";
import { AuthContext } from "../../Context/AuthContext";
import { MdOpenInNew } from "react-icons/md";

const ImageGrid_TextPatternsTab = () => {
  ...
  useEffect(() => {
    axios({
      url: `https://api.unsplash.com/search/photos/?query=textures-patterns&per_page=100&client_id=${API};`,
      method: "GET",
    }).then((res) => {
...
export default ImageGrid_TextPatternsTab;
