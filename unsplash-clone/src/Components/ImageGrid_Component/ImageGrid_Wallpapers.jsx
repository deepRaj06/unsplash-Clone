...
import { Box, Flex, Grid, GridItem, Icon, Image, Link, Spacer, Text, Tooltip } from "@chakra-ui/react";
...
const ImageGrid_Wallpapers = () => {
  ...
  useEffect(() => {
    axios({
      url: `https://api.unsplash.com/search/photos/?query=wallpapers&per_page=100&client_id=${API};`,
      method: "GET",
    }).then((res) => {
...
export default ImageGrid_Wallpapers;
