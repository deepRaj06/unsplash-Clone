import {
  ...
  const Home_ArchitectureTab = () => {
    ...
    const editorialImg = {
      blurImg:
        "url(https://images.unsplash.com/photo-1657794572821-f75d7ead17c0?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1vZi10aGUtZGF5fHx8fGVufDB8fHx8&dpr=1&auto=format%2Ccompress&fit=crop&w=1599&h=594) center/cover no-repeat",
    };
    return (
      <>
                ...
                <Box mt="8rem" mr="auto" ml="auto" w="80%" h="300px">
                  <VStack spacing="24px" alignItems="start">
                    ...
                    <VStack spacing="2px" alignItems="start">
                      ...
                      <Text fontSize="20px" color="white">
                      minimalist structures that will give you a new appreciation for the art of
                      </Text>
                      <Text fontSize="20px" color="white">
                      architecture.
                      </Text>
  ...
  export default Home_ArchitectureTab;
