import {
  ...
  const Home_NatureTab = () => {
    ...
    const editorialImg = {
      blurImg:
        "url(https://images.unsplash.com/photo-1658191342762-989ac7137464?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1vZi10aGUtZGF5fHx8fGVufDB8fHx8&dpr=1&auto=format%2Ccompress&fit=crop&w=1599&h=594) center/cover no-repeat",
    };
    return (
      <>
                  ...
                  <VStack spacing="24px" alignItems="start">
                    ...
                    >
                      <Flex>
                        ...
                        <Text fontWeight="bold">Nature</Text>
                      </Flex>
                    </Button>
                  </VStack>
                </Box>
